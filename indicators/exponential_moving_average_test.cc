...
TEST(ExponentialMovingAverageTest, GetEMAWhenAdding8HourOhlcTicks) {
  ...
  EXPECT_FLOAT_EQ(exponential_moving_average.GetExponentialMovingAverage(), 0);
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 0);
  ...
  EXPECT_FLOAT_EQ(exponential_moving_average.GetExponentialMovingAverage(),
                  120);
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 1);
  ...
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 2);
  ...
  EXPECT_FLOAT_EQ(exponential_moving_average.GetExponentialMovingAverage(),
                  150.0f * 0.25f + (80.0f * 0.25f + 140.0f * 0.75f) * 0.75f);
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 3);
  ...
  EXPECT_FLOAT_EQ(exponential_moving_average.GetExponentialMovingAverage(),
                  300.0f * 0.25f + (400.0f * 0.25f + 125.0f * 0.75f) * 0.75f);
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 4);
                  ...
                  750.0f * 0.25f +       // nowrap
                      (650.0f * 0.25f +  // nowrap
                       (650.0f * 0.25f + 193.75 * 0.75f) * 0.75f) *
                          0.75f);
  EXPECT_EQ(exponential_moving_average.GetNumOhlcTicks(), 6);
}
