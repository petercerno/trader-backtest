...
TEST(SimpleMovingAverageTest, Get3SMAWhenAdding8HourOhlcTicks) {
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(), 0);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 0);
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(), 120);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 1);
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(), 150);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 1);
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(), 140);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 1);
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(),
                  (140.0f + 100.0f) / 2.0f);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 2);
  ...
  EXPECT_FLOAT_EQ(simple_moving_average.GetSimpleMovingAverage(),
                  (140.0f + 80.0f + 150.0f) / 3.0f);
  EXPECT_EQ(simple_moving_average.GetNumOhlcTicks(), 3);
