...
Now we can evaluate a simple `rebalancing` trader over a 5 year time period: `[2017-01-01 - 2022-01-01)` (and log both the exchange states and also the trader internal states) as follows:
